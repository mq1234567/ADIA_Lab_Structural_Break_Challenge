...
The batch bank (sb_bank) recomputes over the whole online buffer each step
(~120 ms/step) -> far over the 15 h budget. Here every feature updates in
constant (or ring-buffer) time as each online point arrives. The SAME StreamState
